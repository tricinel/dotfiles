...
# You can also shorten it to the last n commits by appending n, e.g. glast 2 will get the last 2 commits
alias glast="git --no-pager log --pretty=format:'%Cred%h%Creset %C(cyan)%an%Creset - %C(yellow)%d%Creset %s %Cgreen(%cr)%Creset' --abbrev-commit --date=relative -n"
